...
int main()
{
    ...
    Shader shader("resources/stencil_testing/stencil_testing.vs", "resources/stencil_testing/stencil_testing.frag");
    Shader shaderSingleColor("resources/stencil_testing/stencil_testing.vs", "resources/stencil_testing/stencil_single_color.frag");
