...
int main()
{
    ...
    Shader shader("resources/shadow_mapping/shadow_mapping.vs", "resources/shadow_mapping/shadow_mapping.frag");
    Shader simpleDepthShader("resources/shadow_mapping/shadow_mapping_depth.vs", "resources/shadow_mapping/shadow_mapping_depth.frag");
    Shader debugDepthQuad("resources/shadow_mapping/debug_quad.vs", "resources/shadow_mapping/debug_quad_depth.frag");
