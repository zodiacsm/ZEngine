...
int main()
{
    ...
    Shader shader("resources/cubemaps/cubemaps.vs", "resources/cubemaps/cubemaps.frag");
    Shader skyboxShader("resources/cubemaps/skybox.vs", "resources/cubemaps/skybox.frag");
