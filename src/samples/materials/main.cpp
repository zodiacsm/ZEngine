...
int main()
{
    ...
    Shader lightingShader("resources/materials/materials.vs", "resources/materials/materials.frag");
    Shader lampShader("resources/materials/lamp.vs", "resources/materials/lamp.frag");
